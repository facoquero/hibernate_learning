...
public class User {
    ...
    @Embedded
    @AttributeOverrides(
            {@AttributeOverride(name = "userAddressLine1", column = @Column(name = "USER_ADDRESS_LINE_1")),
                    @AttributeOverride(name = "userAddressLine2", column = @Column(name = "USER_ADDRESS_LINE_2")),
